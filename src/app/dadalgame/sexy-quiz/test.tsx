...
const questions: Question[] = [
  {
    ...
    options: ["감정적 연결", "물리적 만족", "서로의 존중", "새로운 경험"],
  },
  {
    id: 2,
    question: "성적인 대화에 대해 어떻게 생각하시나요?",
    options: [
      "자연스럽게 할 수 있음",
      "조금 부끄러움",
      "상대방이 먼저 시작하기를 기다림",
  ...
  {
    id: 4,
    question: "성적인 욕구가 생겼을 때 어떻게 대처하시나요?",
    options: [
      "상대방과 솔직하게 이야기",
      "혼자 해결",
      "무시하고 넘어감",
  ...
  {
    id: 5,
    question: "성적인 판타지에 대해 어떻게 생각하시나요?",
    options: [
      "상대방과 공유함",
      "혼자만의 비밀",
      "전혀 없음",
  ...
  {
    id: 6,
    question: "성적인 관계에서 가장 스트레스 받는 상황은?",
    options: [
      "상대방의 기대에 못 미칠 때",
      "성적인 대화",
      "새로운 시도",
  ...
  {
    id: 7,
    question: "성적인 관계에서 어떤 역할을 선호하시나요?",
    options: [
      "적극적으로 주도",
      "상대방이 주도하는 것을 선호",
      "서로 번갈아가며",
  ...
  {
    id: 9,
    question: "성적인 관계에서 실패했을 때 어떻게 반응하시나요?",
    options: [
      "상대방과 대화로 해결",
      "혼자 고민함",
      "그냥 넘어감",
  ...
  {
    id: 10,
    question: "성적인 관계에서 가장 중요한 의사소통은?",
    options: [
      "서로의 욕구 표현",
      "즉시 피드백",
      "서로의 공간 존중",
  ...
  {
    id: 11,
    question: "성적인 관계에서 실수를 했을 때 어떻게 하시나요?",
    options: [
      "즉시 사과하고 대화",
      "시간을 두고 생각",
      "상대방이 먼저 말하기를 기다림",
  ...
  {
    id: 14,
    question: "성적인 관계에서 가장 중요한 것은?",
    options: ["서로의 만족", "감정적 연결", "신뢰와 존중", "새로운 경험"],
  },
  {
    id: 15,
    question: "성적인 관계 후 어떻게 하시나요?",
    options: [
      "상대방과 대화하며 정리",
      "즉시 잠",
      "혼자만의 시간",
